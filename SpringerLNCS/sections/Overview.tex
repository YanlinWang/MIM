...
\end{lstlisting}
\lstinline|shuffleAndDraw()| is a designed method that invokes \lstinline|draw()| in its definition. In principle, we want
...
\end{lstlisting}
Since the dynamic type of the receiver is \lstinline|DrawableLoggingDeck|, calling \lstinline|shuffleAndDraw()| triggers the ambiguity.
