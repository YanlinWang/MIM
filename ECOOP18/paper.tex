...
%\author{Yanlin Wang}{The University of Hong Kong}{yanlin@cs.hku.hk}
%\author{Haoyuan Zhang}{The University of Hong Kong}{hyzhang@cs.hku.hk}
\authorrunning{} %mandatory. First: Use abbreviated first/middle names. Second (only in severe cases): Use first author plus ‘et. al.’
