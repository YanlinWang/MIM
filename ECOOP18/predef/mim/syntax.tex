...
\newcommand{\Congruence}{Propagation}
\newcommand{\congruence}{propagation}
...
\newcommand{\interfaceLongExt}[3]{
	\kwinterface \; #1 \; \kwextends \; #2 \; {\{} \overline{#3} {\}}
}
\newcommand{\method}[6]{
...
\newcommand{\momethod}[6]{
  #1 \; #2 (\overline{#3} \; \overline{#4}) \; \kwoverride \; \overline{#5} \; {\{} \kwreturn \; #6 ; {\}}
}
\newcommand{\moabsmethod}[5]{
  #1 \; #2 (\overline{#3} \; \overline{#4}) \; \kwoverride \; \overline{#5} \; ;
}
...
\newcommand{\subextendsForall} {
\inferrule* [right=]
    {\interfaceLongExt{I}{I_1, I_2, ..., I_n}{M}}
    {I \subtype I_1, I \subtype I_2, ..., I \subtype I_n}
}
...
\newcommand{\tmomethod} {
\inferrule* [left=(T-MoMethod)]
    {  \forall J_i \in \overline{J}, I <: J_i \\
    \mostSpecific(m, I, J_i) = \{J_i\} \\
    \mbody(m, J_i, J_i) = (K, \overline{I_x} \; \overline{x}, I_e \; \_) \\
        \judgeewf {\overline{x}:\overline{I_x}, this:I  } {e_0:I_0} \\
        I_0 \subtype I_e
    %\\ \definedin(m, J) % m is (directly or indirectly) defined in J
    }
    {\momethod{I_e}{m}{I_x}{x}{J}{e_0} \text{ OK IN } I}
}
...
\inferrule* [left=(T-Intf)]
    ...
    \forall J \supertype I \text{ and } m, \mbody(m, J, J) \text{ is defined} \Rightarrow \mbody(m, I, J) \text{ is defined} \\ 
    \forall J \supertype I \text{ and } m, I[m \; \kwoverride \; I] \text{ and } J[m \; \kwoverride \; J] \text{ defined}  \Rightarrow \canOverride(m, I, J)
    }
    { \interface{I}{I}{M} \text{ OK }}
}
