...
interface itself, then such a method is seen as originally defined \yanlin{added an explanation} (including the case of merging methods from different branches,  which can be viewed as \emph{reborn}); otherwise it is a hierarchical overriding method. 
