...
We use $I_d, I_s$, since $\mbody$ is usually invoked by a receiver of a method $m$, with its dynamic type $I_d$ and static type $I_s$. Such a function returns the most specific method implementation. \yanlin{Refined.}More
...
\begin{flalign*}
	...
	& \indent\indent \textrm{iff: } I[m\ \kwoverride\ I] = I_e \; m(\overline{I_x} \; \overline{x}) \; \kwoverride \; I \ldots & \\
...
$\mostSpecific(m, I, I)$ represents the set of branches that $I$ inherits on method $m$. $I$ can be instantiated
if and only if for every branch, the most specific implementation is non-abstract. \yanlin{removed 'unambiguous'.}
%%%%============================ canInstantiate end ================%%%%%%%%
