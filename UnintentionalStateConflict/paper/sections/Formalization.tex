...
\begin{figure*}
	\begin{mathpar}
		...
		\textsc{(E-Let)}
		{(H, VS, \mylet{I}{x}{v}{e}, FS) \to 
			(H, \concat{\{ x \to v \}}{VS}, \return{e}, FS)			
		}\\
	   ...
	   {(H, \concat{BS}{VS}, \return{v}, FS) \to 
		...
		{ (H, VS, (J)o.m(\overline{v}), FS) \to
			(H, VS', \return{(I_e)e_0}, FS)  }\\
		\text{ where } H(o) = \obj{I}{\overline{o}}, 
		       VS' = \concat{\{\this \to o, \overline{x \to v} \}}{VS},
		       \mbody(m, I, J) = (I_0, \overline{I_x} \; \overline{x}, I_e \; e_0)
