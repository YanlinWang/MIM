...
% \newcommand{\subtype}   {<:}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% syntax.tex begin %%%%%%%%%%%%%%%%%%%%%%
\newcommand{\fields}{\keyword{fields}}
\newcommand{\kwvoid}{\keyword{void}}
...
\newcommand{\mconstr}{\keyword{mconstr}}
\newcommand{\validMC}{\keyword{validMC}}
...
\newcommand{\interfaceMC}[4]{
\kwinterface \; #1 \; \kwextends \; \overline{#2} \; {\{} #3 \; \overline{#4} {\}}
}
% \newcommand{\prog}[2]{
% 	\overline{#1} \; #2
% }
...
\newcommand{\methodStatic}[4]{
\kwstatic \; #1 \; #2 (\overline{#3} \; \overline{#4}) \;  ;
}
\newcommand{\constructor}[2]{
\kwnew (\overline{#1} \; \overline{#2}) \;  ;
}
\newcommand{\subid} {
\inferrule* [right=]
    {}
