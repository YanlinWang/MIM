...
\inferrule* [left=(T-Method)]
    {  I <: J \\
	    \judgeewf {\overline{x}:\overline{I_X}, this:I	} {e_0:\_ <: I_E} \\
...
{\left(\angl{J}\new{I}\right).m(\overline{\angl{I_E} e}) \to
    \angl{I'_E}[\overline{\angl{I_X} e}/\overline{x}, \angl{I_0}\new{I}/\kwthis]e_0}
}

\newcommand{\spathinvk} {
\inferrule* [left=(S-PathInvk)]
{\mbody(m, I, K) = (I_0, \overline{I_X} \; \overline{x}, I'_E \; e_0)}
{\left(\angl{J}\new{I}\right).K::m(\overline{\angl{I_E} e}) \to
    \angl{I'_E}[\overline{\angl{I_X} e}/\overline{x}, \angl{I_0}\new{I}/\kwthis]e_0}
}
...
{\kwsuper.K::m(\overline{\angl{I_E} e}) \to
    \angl{I'_E}[\overline{\angl{I_X} e}/\overline{x}, \angl{I_0}\new{I}/\kwthis]e_0}
}
