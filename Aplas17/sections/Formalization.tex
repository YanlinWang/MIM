...
\kwoverride keyword\bruno{use \\xspace to deal with the spacing issues
in commands like override} to override an old implementation of the
...
\end{array}
\end{displaymath}
\caption{Syntax. *: only intended for semantic rules. \red{Do we need "this"?}}\label{fig:syntax}
\end{figure*}
...
\begin{mathpar}
	...
	\ssuperinvk
\end{mathpar}
\caption{Small-step semantics.\red{Haoyuan: TODO: <???> new I()/this}}\label{fig:smallstep}
\end{figure*}
