...
approaches to multiple inheritance is \emph{traits}. Traits offers a
restricted model of multiple inheritance that is easy to reason and 
has many elegant properties. Traits has good support for method 
...
method conflicts. In our new trait model conflicting methods arising
