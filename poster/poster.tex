...
\headerbox{Real Conflicts}{name=implementation,column=0,below=contribution}{

\noindent{\centering\includegraphics[width=5em]{../ECOOP18/pics/P1.pdf}\\}
\vspace{0.5em}
\noindent{\centering\includegraphics[width=5em]{../ECOOP18/pics/P4.pdf}\\}
\vspace{0.1em}

\begin{enumerate}
\item Real conflicts needs to be explicitly resolved by programmers. \\
\item Existing OOP models have taken care of this case intensively.
\end{enumerate}
% \begin{figure*}
% \begin{tabular}{clcl}
% &\multicolumn{1}{c}{\includegraphics[width=5em]{../ECOOP18/pics/P1.pdf}} & & 
% \multicolumn{1}{c}{\includegraphics[width=5em]{../ECOOP18/pics/P4.pdf}}\\
% \end{tabular}
% \end{figure*}
}

  \headerbox{Unintentional Conflicts}{name=uml,column=0,below=implementation,above=bottom}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\noindent{\centering\includegraphics[width=\linewidth]{../ECOOP18/pics/conflicts.png}\\}
\vspace{0.1em}
\begin{enumerate}
\item Conflicting methods have completely different meaning/domain which just share the same name (and parameter types). 
\item Few existing OOP models support unintentional method conflicts well. 
\end{enumerate}
}
...
\vspace{-0.5em}
\headerbox{P1: basic unintentional method conflicts}{name=Model,column=1,span=2,row=0}{
\lstinputlisting[linerange=1-6]{./src/src1.txt}
}

\vspace{-0.5em}
\headerbox{P2: dynamic dispatching}{name=results,column=1,span=2,row=0,below=Model}{
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  \begin{multicols}{2}
...
\lstinputlisting[linerange=9-17]{./src/src1.txt}
}

\vspace{-0.5em}

\headerbox{P3: overriding on individual branches}{name=with,column=1,span=2,row=0,below=results}{

\lstinputlisting[linerange=20-29]{./src/src1.txt}
}

\vspace{-0.5em}
\headerbox{Syntax}{name=syntax,column=1,span=2,row=0,below=with}{
\noindent{\includegraphics[width=0.9\linewidth]{pdfs/syntax.png}}
}
\vspace{-0.5em}

\headerbox{The Key Semantics Rule}{name=semantics,column=1,span=2,row=0,below=syntax}{
\noindent{\includegraphics[width=0.85\linewidth]{pdfs/semantics2.png}}
}
\vspace{-0.5em}


\headerbox{More in the paper}{name=more,column=1,span=2,row=0,below=semantics}{
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{multicols}{2}
\begin{itemize}
\item Intuitive examples
\item Subtyping, typing and reduction rules
\item Design choices
\item Extensions
\item Properties/Proofs
\item ...
\end{itemize}
\end{multicols}
...
%   }
  ...
  \headerbox{Contacts}{name=acknowledge,column=1,span=2,below=more,above=bottom}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
