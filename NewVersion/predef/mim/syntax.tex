...
\inferrule* [left=(T-Intf)]
    ...
    \forall J >: I, K >:J \text{ and } m, \mbody(m, J, K) \text{ is defined} \Rightarrow \mbody(m, I, K) \text{ is defined} \\ 
    \forall J >: I \text{ and } m \in \overrideSet(I, I), m \in \overrideSet(J, J)  \Rightarrow \canOverride(m, I, J)
    }
    { \interface{I}{I}{M} \text{ OK }}
}

\newcommand{\tanno} {
\inferrule* [left=\red{(T-Anno)}]
    {  \judgeewf \Gamma e:I  \\
       I \subtype J  }
    { \judgeewf \Gamma {\angl{J}e : J} }
}
...
{\left(\angl{J}\new{I}\right).m(\overline{v}) \to
    \left(\angl{J}\new{I}\right).J?m(\overline{v})}
}

\newcommand{\spathinvk} {
\inferrule* [left=(S-PathInvk)]
{\mbody(m, I, K) = (I_0, \overline{I_x} \; \overline{x}, I_e \; e_0) 
%\\ e_0 \neq \o
}
