...
\inferrule* [left=(T-Invk)]
    ...
    \\ \mbody(m, I_0, I_0) = (K, \overline{J} \; \overline{x}, I \; \marcoT{\_}) 
...
\inferrule* [left=(T-PathInvk)]
    {  \judgeewf \Gamma {e_0:I_0}
    \\ I_0 \subtype J_0
    \\ \mbody(m, I_0, J_0) = (K, \overline{J} \; \overline{x}, I \; \marcoT{\_}) 
    \\ \judgeewf \Gamma \overline{e}:\overline{I}
    \\ \overline{I} \subtype \overline{J}
    }
...
\inferrule* [left=(T-StaticInvk)]
    {\marcoT{\judgeewf \Gamma {e_0:I_0}}
   \\ \marcoT{I_0 \subtype J_0}
    \\  \mbodyStatic(m, J_0, J_1) = (K, \overline{J} \; \overline{x}, I \; \marcoT{\_})
    \\ \judgeewf \Gamma \overline{e}:\overline{I}
    \\ \overline{I} \subtype \overline{J}
    }
...
\newcommand{\tintf} {
\inferrule* [left=(T-Intf)]
    {  \marco{Is needed?\overline{I} \text{ OK}}
    \\ \marco{Is this premise ok? \overline{M} \text{ OK IN } I
...
{\left(\angl{J}\new{I}\right).\staAnno{K}{K'}m(\marcoT{\overline{v}}) \to
    \angl{I'_e}[
  \marcoT{\overline{\angl{I_x}} \overline{v}}
  /\overline{x}, \angl{I_0}\new{I}/\kwthis]e_0}
}
