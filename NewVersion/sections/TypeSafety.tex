...
\textcolor{red}{By \textsc{(T-Anno)}, we have $I \subtype J$. Also, by \textsc{(T-PathInvk)}, $\judgeewf {\Gamma} {\overline{v} : \overline{I_v} \subtype \overline{I_x}}$.}

\noindent \textcolor{red}{So the first substitution preserves typing, On the other hand, .... the second one also preserves typing. Hence $I'_e \subtype$ type of $e_0 \subtype I_e$.}
