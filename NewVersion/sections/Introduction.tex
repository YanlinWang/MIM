...
and mixins~\cite{bracha90mixin}\bruno{please add more references to
  other work on traits and mixins here} to offer a disciplined form of multiple inheritance. Java 8 
...
This paper proposes \textit{hierarchical dispatching}: a novel approach
