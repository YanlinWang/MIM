...
\item S2, should remove the discussion about JFrmae. all return type void.
\item S2, mention DrawableDeck in P2.3 is a new version of DrawableDeck before.
\item S2, “Ideally, we want that invocation to be dynamically dispatched.” --> “In FHJ, this invocation is dynamically dispatched.“. and revise the following paragraph on “we may have to copy the shuffleAndDraw code into SafeDeck, so as to be adaptive to the new draw. “.
...
\item in Figure 1, the UML diagram on the right side is not quite right, 
