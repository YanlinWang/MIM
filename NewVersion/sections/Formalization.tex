...
\begin{mathpar}
	...
	\tpathinvk \\
	% \tsuperinvk \\
	\tstaticinvk  \yanlin{refined.}\\
	\tnew \\
	\tmethod \\
	\tabsmethod \\
	\tintf \yanlin{refined.}
\end{mathpar}
\marco{There is no typing rule for <I>e}
\yanlin{annotation <I> is not created by programmers, do we need to type check it, maybe not?}
...
\begin{mathpar}
	...
	% \ssuperinvk \\
	\sstaticinvk \\
	\yanlin{\textit{we were using e, if change to v, then this <I>v annotation is OK.}}
	\\
