\section{Fundamental Notions}\label{subsec:auxdefs}
In this section, we present the fundamental notions used in our formalization.
...
\bruno{explain: where are these definitions used and for what purpose?
  You need similar explanations everywhere you introduce new definitions.}
...
\bruno{do not use the names of the definitions as titles of
  Sections. Please give a title that states the purpose. 
For this section in particular it may be something like ``Finding the most
