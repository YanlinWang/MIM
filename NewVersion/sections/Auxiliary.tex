...
\begin{figure*}[t]
    ...
    \inferrule* [left=]
    { set1 = \; \{K\mid I <: K, \; K <: J\; $and$\; m \in \overrideSet(K, K) \} \\
        set2 = \; \{K\mid  J <: K \; $and$\; m \in \overrideSet(K, K) \} }
    {\mostSpecific(m, I, J) = \left\{{\begin{tabular}{ll}
                $prune(set1)$ & if $set1$ is not empty \\ $prune(set2)$ & otherwise
            \end{tabular}}\right.}
    
    \inferrule* [left=]
        { set = \; \{ K\mid I <: K, \; K <: J\; $and$ \;
    ...
    {   \interface{I}{I}{M}
        \\ J \in \overline{I} }
    {\ext(I, J) \marco{Is this ever used?}}
...
\begin{mathpar}
    \inferrule* [left=]
        {  %\mostSpecific(m, I, I) = \{J\} \\
            \kwinterface \; J \; \kwextends \; \overline{J} \; \{\method{I_e}{m}{I_x}{x}{\marcoT{J'}}{e_0}\ldots\}}
        {\mbodyStatic(m, J, J') = (J, \overline{I_x} \; \overline{x}, I_e \; e_0)}

    \inferrule* [left=]
        {  %\mostSpecific(m, I, I) = \{J\} \\
            \kwinterface \; J \; \kwextends \; \overline{J} \; \{\absmethod{I_e}{m}{I_x}{x}{\marcoT{J'}}\ldots\}}
