...
\yanlin{title changed, is this ok?}
...
\bruno{Yes, I agree with Marco: we can move 3.4 to the end of Section
  4. Don't forget to revise earlier parts of Section 3 to remove
  mentions of type-soundness there. Or better, in the summary of
  Section 3 you can point out that type soundness is proved at the 
end of Section 4.
}\yanlin{Revised, please check.}
