...
introduce the basic functions: $\ext, I.m\,\kwoverride\,J$ and $\prune$. $\ext(I, J)$
...
in their signatures. \marco{text need to change since notation is changed.} Notice that $\overrideSet(I, I)$ is a special representative of
...
\begin{figure*}[t]
    ...
    \inferrule* [left=]
    { origins = \; \{K \mid \subt{I}{K}, \; \subt{K}{J} \; \lor \; \subt{J}{K}, \; $and$\; K.m\,\kwoverride\,K \} }
    {\mostSpecific(m, I, J) = \prune(origins) }

    
    \inferrule* [left=]
        { overrides = \; \{ K\mid I <: K, \; K <: J\; $and$ \;
            K.m\,\kwoverride\,J  \} }
        {\mostSpecificOverride(m, I, J) = \prune(overrides)}
