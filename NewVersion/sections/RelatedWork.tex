...
\noindent {\bf C++ model.}
C++ supports a very flexible inheritance model (normal inheritance and virtual inheritance). 
It allows the existence of unintentional conflicts and users may specify a hierarchical path via cast for disambiguation, as discussed in Section~\ref{sec:overview}. 
...
Section~\ref{sec:formalization}.\bruno{put reference and make sure that we discuss this topic}
