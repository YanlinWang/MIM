...
implementation. There are several formalizations~\cite{Wasserrab2006,ramananandro2012mechanized,Ramalingam1997} in the literature modeling C++ various features and give us some inspiration, however, as far as we know, there is no any formal model that
