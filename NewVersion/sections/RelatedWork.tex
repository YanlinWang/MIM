...
\noindent {\bf C++ model.}
C++ supports a very flexible inheritance model (including basic and
virtual inheritance). \bruno{what is ``normal'' inheritance?}\yanlin{changed "normal" to "basic", is this ok?}
