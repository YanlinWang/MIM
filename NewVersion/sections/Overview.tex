...
Notably, we track the static types by adding casts. In contrast to FJ,
...
\lstinline|(C) new C()|, which is a value in \MIM{}. This rule is
...
reduction, the cast that tracks the origin of
\lstinline|shuffleAndDraw| is crutial to unambiguously find the
