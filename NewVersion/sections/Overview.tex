...
will be introduced later.\bruno{avoid using words like ``later'' or
  ``before''. Instead use references to the actual Sections.}
...
\end{lstlisting}\vspace{3pt}\bruno{make override a keyword in
  lstlisting.}
