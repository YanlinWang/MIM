...
\lstinline|Drawable|
the program create a blank canvas by \lstinline|JFrame| and set the visibility to \lstinline|true|.
...
some quick examples. The UML diagrams present the hierarchy. In (c) and (e), an up-arrow $\uparrow$ is short for ``\lstinline|override|''.
